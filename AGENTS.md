...
- After `05-review-release` passes, the workflow automatically regenerates `workspace/README.md` from the approved current-version requirement under `## 当前系统功能说明` and updates `<!-- workflow:workspace-readme-version: v{major}.{minor} -->`; do not manually maintain this file.
