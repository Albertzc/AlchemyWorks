...
| 路径 | 必需内容 | 用途 |
|---|---|---|
| `.workflow/` | `workflow.py`、`README.md` | 工作流 CLI（含 baseline 核心流程原型与迭代按需原型门禁、文档变更后的 `refresh` 同步命令、版本归档前 `workspace/README.md` 功能说明刷新门禁、已归档版本 Context Pack 缓存清理）及其操作说明。 |
